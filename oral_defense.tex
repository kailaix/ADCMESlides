...
\begin{frame}		
	\begin{figure}[hbt]
		\centering
		\includegraphics[width=1.0\textwidth]{figures/thesis/outline4}
	\end{figure}
\end{frame}
...
\begin{aligned}
	...
	L^D(\{ u_i\}, \{\hat u_i\}; {\color{red}\xi}) =& -\frac{1}{n}\sum_{i=1}^n D_{\color{red}\xi}( u_i)
\end{aligned}
\end{equation*}
\end{itemize}  
	\end{itemize}
...
\end{minipage}~
\begin{minipage}{0.3\textwidth}
	\includegraphics[width=0.8\textwidth]{figures/thesis/optimal}
\end{minipage}
